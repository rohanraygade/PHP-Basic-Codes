...
<?php
echo "<h3>Code 8 </h3>";
$capitals = array( "Italy"=>"Rome", "Luxembourg"=>"Luxembourg", "Belgium"=> "Brussels", "Denmark"=>"Copenhagen",
    ...
    "Hungary"=>"Budapest", "Latvia"=>"Riga", "Malta"=>"Valetta", "Austria" => "Vienna", "Poland"=>"Warsaw") ;
     asort($capitals);
foreach ($capitals as $country => $capitals)
{
    echo "The capital of $country is $capitals"."<br>";
}
"<br><br>";
?>
</body>
